...
- DATE DETECTION: If the user mentions a past date (e.g. "ayer", "anteayer", "el viernes", "hace 2 días", "yesterday"), include "daysAgo": N in the root JSON (1 for yesterday, 2 for day before, etc.). If the user says "hoy" or doesn't mention a date, omit this field or set to 0.`,
...
`;
  ...
  private extractCompoundFoodItems(message: string): CalorieEntryItem[] {
    ...
    const baseFoods: Record<string, number> = {
      ...
      camote: 120, yuca: 150,
      choclo: 130, elote: 130, corn: 130, maíz: 130, maiz: 130,
      repollo: 25, cabbage: 25, col: 25,
      coliflor: 25, pepino: 15, calabaza: 40, zapallo: 40,
